...
from lekiwi_control.utils.errors import DeviceAlreadyConnectedError, DeviceNotConnectedError
...
class OpenCVCamera(Camera):
    ...
    Example:
        ```python
        from lekiwi_control.cameras.opencv import OpenCVCamera
        from lekiwi_control.cameras.configuration_opencv import OpenCVCameraConfig, ColorMode, Cv2Rotation
